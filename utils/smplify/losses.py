...
def body_fitting_loss_smplify_x(body_pose, betas, pose_embedding, camera_t, camera_center, model_joints, joints_conf, joints_2d,
                                focal_length=5000, sigma=100,
                                body_pose_weight=4.78, shape_prior_weight=5, angle_prior_weight=15.2, output='sum'):
